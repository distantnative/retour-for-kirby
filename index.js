(function() {
  ...
  var _sfc_render$d = function render() {
    ...
    }, proxy: true } : null], null, true) }, [_vm.stats ? _c("k-retour-stats", { attrs: { "data": _vm.stats, "timespan": _vm.timespan } }) : _vm._e(), _c("k-retour-tabs", { attrs: { "tab": _vm.tab, "tabs": _vm.tabs, "buttons": [{ icon: "search", click: _vm.toggleSearch }, ..._vm.buttons] } }), _vm.searching ? _c("k-input", { staticClass: "k-models-section-search", attrs: { "autofocus": true, "placeholder": _vm.$t("search") + " …", "value": _vm.q, "type": "text" }, on: { "input": function($event) {
      _vm.q = $event;
  ...
  var _sfc_render$a = function render() {
    ...
    return _c("k-inside", { staticClass: "k-retour-view k-retour-system-view", scopedSlots: _vm._u([{ key: "topbar", fn: function() {
      return [_c("k-retour-timespan", { attrs: { "timespan": _vm.timespan } })];
    }, proxy: true }]) }, [_vm.stats ? _c("k-retour-stats", { attrs: { "data": _vm.stats, "timespan": _vm.timespan } }) : _vm._e(), _c("k-retour-tabs", { attrs: { "tab": "system", "tabs": _vm.tabs, "buttons": [
      {
    ...
    ] } }), _c("k-stats", { attrs: { "reports": _vm.reports } }), _c("k-text", { staticClass: "k-help", domProps: { "innerHTML": _vm._s(
