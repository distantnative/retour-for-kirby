...
return [
    ...
    'retour.routes.fields.from.help' => '<a href="{docs}" target="_blank">Dinamik yer tutucuları</a> ekleyin ve yönlendirmede <a href="{docs}" target="_blank">kullanın</a>.',
    'retour.routes.fields.to' => 'Adresine yönlendir',
