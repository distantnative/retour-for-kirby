...
return [
    ...
    'retour.tbl.perPage'         => 'affichées',
    'retour.tbl.redirects.empty' => 'Aucune redirection',
    'retour.tbl.fails.empty'     => 'Aucun échec détecté',

    'retour.stats.month' => 'Mois',
    'retour.stats.week'  => 'Semaine',
    'retour.stats.day'   => 'Jour',

    'retour.redirected' => 'Redirigée(s)',
    'retour.resolved'   => 'resolved',
    'retour.failed'     => 'Échec(s)',
    ...
    'retour.fails.referrer'    => 'Référent',

    'retour.hits'            => 'Requêtes traitées',
    'retour.hits.last'        => 'Dernière',


    'retour.settings.support'           => 'Soutenir le développement',
    'retour.settings.supporetour.donate'    => 'Donation',
    'retour.settings.log.clear'         => 'Vider le log',
    'retour.settings.log.clear.confirm' => 'Voulez-vous vraiment vider le log?',
