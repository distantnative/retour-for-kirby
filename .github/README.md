...
[![Version](https://img.shields.io/badge/release-2.2.0-rc.1-4271ae.svg?style=for-the-badge)](https://github.com/distantnative/retour-for-kirby/releases)
...
| `distantnative.retour.ignore` | `[]` | Array of paths to ignore |
...
#### Update
Creating, updateing and deleting redirects is tied to the `site.update` permission:
